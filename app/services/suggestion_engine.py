...
class SuggestionEngine:
    ...
    def _suggestions_after_action(
        ...
        mapping = {
            ...
            "complete_followup": ["Show follow-up history", "Schedule next follow-up"],
            "reschedule_followup": ["Show follow-up history", "Add a note"],
            "bulk_update_followups": ["Show today's follow-ups", "Show overdue follow-ups"],
            "get_stale_followups": ["Close stale follow-ups", "Reschedule stale follow-ups"],
            ...
            "query_invoices": ["Show billing analytics", "Show overdue invoices"],
            "update_invoice": ["Generate updated PDF", "Share on WhatsApp"],
